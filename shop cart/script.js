...
function createCartProt(title,rate,img){
 ...
 <img src=${img} alt="" class="w-25 img-thumbnail">
     <div class="mt-2 item" style="margin-left: 20%;">
         ...
         <input type="number" value="1" id="" class="w-25 qty_counter"><input type="button" value="Add" class="btn btn-secondary" onclick="add()" style=" margin-left: 10px; height: 25px; padding:0px ;">
